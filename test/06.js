const { compareHash, RequestError, ResponseError, hash } = require("./utils");
...
describe("06 - Submit a new product", function () {
  ...
  describe("Response", function () {
    ...
    it("it should have the appropriate response body", function (done) {
      ...
      if (answer.response.body !== null)
        answer.response.body = !!answer.response.body;
      if (test) return done();
